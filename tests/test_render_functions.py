...
def test_render_slowlog():
    server_resp = [
        [130, 1575442556, 53, [b"INFO"], b"127.0.0.1:58527", b""],
        [129, 1575442551, 74, [b"slowlog", b"get", b"11"], b"127.0.0.1:58487", b""],
    ]
    config.raw = True
    assert renders.render_slowlog(server_resp) == (
        b"130\n1575442556\n53\nINFO\n127.0.0.1:58527\n\n"
        b"129\n1575442551\n74\nslowlog\nget\n11\n127.0.0.1:58487\n"
    )
    ...
    config.raw = False
    config.version = "4.1"
    assert renders.render_slowlog(server_resp) == FormattedText(
        [
            ("", "1) "),
            ("class:field", "Slow log id: "),
            ("class:string", "130"),
            ("", "\n"),
            ("class:field", "   Start at: "),
            ("class:string", "1575442556"),
            ("", "\n"),
            ("class:field", "   Running time(ms): "),
            ("class:string", "53"),
            ("", "\n"),
            ("class:field", "   Command: "),
            ("class:string", "INFO"),
            ("", "\n"),
            ("class:field", "   Client IP and port: "),
            ("class:string", "127.0.0.1:58527"),
            ("", "\n"),
            ...
            ("", "\n"),
            ("class:field", "   Start at: "),
            ("class:string", "1575442551"),
            ("", "\n"),
            ("class:field", "   Running time(ms): "),
            ("class:string", "74"),
            ("", "\n"),
            ("class:field", "   Command: "),
            ("class:string", "slowlog get 11"),
            ("", "\n"),
            ("class:field", "   Client IP and port: "),
            ("class:string", "127.0.0.1:58487"),
            ("", "\n"),
            ("class:field", "   Client name: "),
            ("class:string", ""),
        ]
...
def test_slowlog_before_40():

    server_resp = [
        [130, 1575442556, 53, [b"INFO"]],
        [129, 1575442551, 74, [b"slowlog", b"get", b"11"]],
    ]
    config.raw = False
    config.version = "2.0"
    assert renders.render_slowlog(server_resp) == FormattedText(
